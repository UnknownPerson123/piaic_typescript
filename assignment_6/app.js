...
function updateData(arr, index, value) {
...
function updateItem(itemName, updatedItem) {
    const index = findItem(itemName);
    console.log(index);
    if (index >= 0) {
...
const numArr = [39, 74, 54, 8, 55, 34, 24, 97, 77, 35, 65, 48, 41, 21, 64, 5, 33, 50, 82, 98, 78, 18, 93, 19, 11, 100, 42, 17, 25, 79, 73, 71, 95, 14, 15, 46, 29, 16, 67, 89, 88, 13, 99, 20, 32, 10, 85, 61, 28, 37, 72, 23, 92, 76, 68, 38, 59, 94, 66, 44, 9, 81, 51, 58, 52, 36, 31, 53, 60, 96, 45, 75, 90, 27, 86, 57, 47, 22, 62, 2, 70, 49, 12, 3, 43, 7, 63, 87, 1, 40, 83, 56, 69, 30, 6, 4, 26, 80, 91, 84];
